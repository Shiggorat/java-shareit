        ...
        mvc.perform(
                ...
                .andExpect(
                        jsonPath("$.comments[0].id", is(itemWithCommentsAndBookings
                                .getComments().getFirst().getId()), Long.class)
                )
                .andExpect(
                        jsonPath("$.comments[0].text", is(itemWithCommentsAndBookings
                                .getComments().getFirst().getText()))
                )
                .andExpect(
                        jsonPath(
                                "$.comments[0].authorName",
                                is(itemWithCommentsAndBookings.getComments().getFirst().getAuthorName())
                        )
                )
